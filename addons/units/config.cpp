...
class CfgPatches {
    class ADDON {
        units[] = {
            ...
            QCLASS(Item_Uniform_Garment_LS_BS_EP_TB),
            ...
            QCLASS(Item_Uniform_Garment_RS_BS_TP_TB),
            ...
            QCLASS(Item_Uniform_TShirt_JP_LS_TP_BB),
