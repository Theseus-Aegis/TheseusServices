...
class CLASS(Unit_I_Bodyguard): CLASS(Unit_Polo_CP_LS_TP_OB) {
    ...
    linkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "G_Shades_Black", QCLASS(Vest_Tactical_DarkBlack)};
    respawnLinkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "G_Shades_Black", QCLASS(Vest_Tactical_DarkBlack)};
...
class CLASS(Unit_I_Contractor): CLASS(Unit_Polo_TP_LS_TP_TB) {
    ...
    linkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "G_Shades_Black", QCLASS(Vest_PlateCarrier_MARPAT)};
    respawnLinkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "G_Shades_Black", QCLASS(Vest_PlateCarrier_MARPAT)};
...
class CLASS(Unit_I_Engineer): CLASS(Unit_Polo_TP_LS_TP_TB) {
    ...
    linkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "G_Shades_Black", QCLASS(Vest_PlateCarrier_Green)};
    respawnLinkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "G_Shades_Black", QCLASS(Vest_PlateCarrier_Green)};
...
class CLASS(Unit_I_Medic): CLASS(Unit_Combat_RS_BS_GP_BB) {
    ...
    linkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "G_Shades_Black", QCLASS(Helmet_Ballistic_DarkBlack), QCLASS(Vest_Tactical_DarkBlack)};
    respawnLinkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "G_Shades_Black", QCLASS(Helmet_Ballistic_DarkBlack), QCLASS(Vest_Tactical_DarkBlack)};
...
class CLASS(Unit_I_Specialist): CLASS(Unit_Combat_RS_BS_GP_BB) {
    ...
    linkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "G_Shades_Black", QCLASS(Vest_PlateCarrierFull_Black)};
    respawnLinkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "G_Shades_Black", QCLASS(Vest_PlateCarrierFull_Black)};
...
class CLASS(Unit_I_TeamLeader): CLASS(Unit_TShirt_JP_GS_LP_BB) {
    ...
    linkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "G_Shades_Black", QCLASS(Cap_Headphones_BlackLogo), QCLASS(Vest_PlateCarrier_Khaki)};
    respawnLinkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "G_Shades_Black", QCLASS(Cap_Headphones_BlackLogo), QCLASS(Vest_PlateCarrier_Khaki)};
...
class CLASS(Unit_I_PilotHeli): CLASS(Unit_Combat_RS_BS_GP_BB) {
    ...
    linkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", QCLASS(Helmet_PilotHeli_Tan), QCLASS(Vest_Tactical_DarkBlack)};
    respawnLinkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", QCLASS(Helmet_PilotHeli_Tan), QCLASS(Vest_Tactical_DarkBlack)};
