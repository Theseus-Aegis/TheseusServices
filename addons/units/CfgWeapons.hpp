class CfgWeapons
{
    ...
    // Plaid
    class CLASS(Uniform_Combat_LS_BPS_BP_BB_CO) : CLASS(Uniform_Base)
    { // Buffalo Plaid Shirt
        scope = 2;
    ...
    class CLASS(Uniform_Combat_LS_DES_TP_TB_CO) : CLASS(Uniform_Base)
    { // Dark Earth Plaid
        scope = 2;
        author = "GilleeDoo, Tyrone";
    ...
    class CLASS(Uniform_Combat_LS_DFS_GP_TB_CO) : CLASS(Uniform_Base)
    { // Dark Foliage Plaid
        scope = 2;
        author = "GilleeDoo, Tyrone";
    ...
    class CLASS(Uniform_Combat_LS_LES_TP_BB_CO) : CLASS(Uniform_Base)
    { // Light Earth Plaid
        scope = 2;
        author = "GilleeDoo, Tyrone";
    ...
    class CLASS(Uniform_Combat_LS_LFS_GP_BB_CO) : CLASS(Uniform_Base)
    { // Light Foliage Plaid
        scope = 2;
        author = "GilleeDoo, Tyrone";
    ...
    class CLASS(Uniform_Combat_LS_CDBS_GP_TB) : CLASS(Uniform_Base)
    { // CDB = Plaid Dark Blue
        scope = 2;
        author = "Pomigit, Jonpas";
    ...
    class CLASS(Uniform_Combat_LS_CLBS_GP_BB) : CLASS(Uniform_Base)
    { // CLB = Plaid Light Blue
        scope = 2;
        author = "Pomigit, Jonpas";
    ...
    class CLASS(Uniform_Combat_LS_CLRS_TP_BB) : CLASS(Uniform_Base)
    { // CLR = Plaid Light Red
        scope = 2;
        author = "Pomigit, Jonpas";
    ...
    class CLASS(Uniform_Combat_LS_CPS_BP_BB) : CLASS(Uniform_Base)
    { // CP = Plaid Purple
        scope = 2;
        author = "Pomigit, Jonpas";
    ...
    class CLASS(Uniform_Combat_RS_BS_DGP_BB) : CLASS(Uniform_Base)
    { // DG = Digital Green
        scope = 2;
        author = "Pomigit, Jonpas";
    ...
    // Plaid
    class CLASS(Uniform_Combat_RS_BPS_BP_BB_CO) : CLASS(Uniform_Base)
    { // Buffalo Plaid Shirt
        scope = 2;
        author = "GilleeDoo, Tyrone";
    ...
    class CLASS(Uniform_Combat_RS_DES_TP_TB_CO) : CLASS(Uniform_Base)
    { // Dark Earth Plaid
        scope = 2;
        author = "GilleeDoo, Tyrone";
    ...
    class CLASS(Uniform_Combat_RS_DFS_GP_TB_CO) : CLASS(Uniform_Base)
    { // Dark Foliage Plaid
        scope = 2;
        author = "GilleeDoo, Tyrone";
    ...
    class CLASS(Uniform_Combat_RS_LES_TP_BB_CO) : CLASS(Uniform_Base)
    { // Light Earth Plaid
        scope = 2;
        author = "GilleeDoo, Tyrone";
    ...
    class CLASS(Uniform_Combat_RS_LFS_GP_BB_CO) : CLASS(Uniform_Base)
    { // Light Foliage Plaid
        scope = 2;
        author = "GilleeDoo, Tyrone";
    ...
    class CLASS(Uniform_Garment_LS_OS_EP_TB) : CLASS(Uniform_Base)
    { // O = Brown, E = Grey
        scope = 2;
        author = "Pomigit, Jonpas";
    ...
    class CLASS(Uniform_Garment_LS_GS_EP_TB) : CLASS(Uniform_Base)
    { // E = Grey
        scope = 2;
        author = "Pomigit, Jonpas";
    ...
    class CLASS(Uniform_Garment_LS_ES_EP_TB) : CLASS(Uniform_Base)
    { // E = Grey
        scope = 2;
        author = "Pomigit, Jonpas";
    ...
    class CLASS(Uniform_Garment_LS_ES_BP_BB) : CLASS(Uniform_Base)
    { // E = Grey
        scope = 2;
        author = "Pomigit, Jonpas";
    ...
    class CLASS(Uniform_Garment_LS_ES_GP_BB) : CLASS(Uniform_Base)
    { // E = Grey
        scope = 2;
        author = "Pomigit, Jonpas";
    ...
    class CLASS(Uniform_Garment_RS_OS_EP_TB) : CLASS(Uniform_Base)
    { // O = Brown, E = Grey
        scope = 2;
        author = "Pomigit, Jonpas";
    ...
    // Polo - Tactical Pants
    class CLASS(Uniform_Polo_TP_LS_TP_TB) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Rory";
    ...
    class CLASS(Uniform_Polo_TP_LS_TP_TB_NoLogo) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
    ...
    class CLASS(Uniform_Polo_TP_BS_LP_BB) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Rory";
    ...
    class CLASS(Uniform_Polo_TP_BS_LP_BB_NoLogo) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Kresky";
    ...
    class CLASS(Uniform_Polo_TP_LS_GP_BB) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Rory";
    ...
    class CLASS(Uniform_Polo_TP_LS_GP_BB_NoLogo) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Kresky";
    ...
    class CLASS(Uniform_Polo_TP_OS_TP_BB) : CLASS(Uniform_Base)
    { // O = Brown
        scope = 2;
        author = "Pomigit, Jonpas, Rory";
    ...
    class CLASS(Uniform_Polo_TP_OS_TP_BB_NoLogo) : CLASS(Uniform_Base)
    { // O = Brown
        scope = 2;
        author = "Pomigit, Jonpas, Kresky";
    ...
    class CLASS(Uniform_Polo_TP_OS_LP_BB) : CLASS(Uniform_Base)
    { // O = Brown, L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Rory";
    ...
    class CLASS(Uniform_Polo_TP_OS_LP_BB_NoLogo) : CLASS(Uniform_Base)
    { // O = Brown, L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Kresky";
    ...
    class CLASS(Uniform_Polo_TP_WS_LP_BB) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Rory";
    ...
    class CLASS(Uniform_Polo_TP_WS_LP_BB_NoLogo) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Kresky";
    ...
    class CLASS(Uniform_Polo_TP_WS_GP_BB) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Rory";
    ...
    class CLASS(Uniform_Polo_TP_WS_GP_BB_NoLogo) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Kresky";
    ...
    // Polo - Cord Pants
    class CLASS(Uniform_Polo_CP_LS_TP_OB) : CLASS(Uniform_Base)
    { // O = Brown
        scope = 2;
        author = "Pomigit, Jonpas";
    ...
    class CLASS(Uniform_Polo_CP_RS_LP_BB) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
        author = "Pomigit, Jonpas";
    ...
    // TShirt - Jean Pants
    class CLASS(Uniform_TShirt_JP_GS_LP_BB) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Rory";
    ...
    class CLASS(Uniform_TShirt_JP_GS_TP_BB) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Rory";
    ...
    class CLASS(Uniform_TShirt_JP_BS_LP_BB) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Rory";
    ...
    class CLASS(Uniform_TShirt_JP_LS_LP_BB) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Rory";
    ...
    class CLASS(Uniform_TShirt_JP_WS_LP_BB) : CLASS(Uniform_Base)
    { // L = Blue
        scope = 2;
        author = "Pomigit, Jonpas, Rory";
