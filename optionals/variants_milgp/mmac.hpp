...
class CCLASS(mmac_assaulter_gry): milgp_v_mmac_assaulter_rgr {
    displayName = CSTRING(mmac_assaulter_gry);
    MACRO_MMAC_GRY
};

class milgp_v_mmac_assaulter_belt_rgr;
class CCLASS(mmac_assaulter_belt_gry): milgp_v_mmac_assaulter_belt_rgr {
    displayName = CSTRING(mmac_assaulter_belt_gry);
    MACRO_MMAC_BELT_GRY
};

// Assaulter Black
class CCLASS(mmac_assaulter_blk): milgp_v_mmac_assaulter_rgr {
    displayName = CSTRING(mmac_assaulter_blk);
    MACRO_MMAC_BLK
};

class CCLASS(mmac_assaulter_belt_blk): milgp_v_mmac_assaulter_belt_rgr {
