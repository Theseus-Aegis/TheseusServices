...
class CLASS(Arcadian_Base): Car_F {
    ...
    driverLeftH&&AnimName = "drivewheel";
    driverRightH&&AnimName = "drivewheel";
    transportSoldier = 5;
    ...
    #include "CfgVehicles\config_sound.hpp"
    #include "CfgVehicles\config_physx.hpp"
    class SimpleObject {
        animate[] = {
            {"damageHide", 0},
            {"damageHideVez", 0},
    ...
    class Turrets: Turrets {
        class MainTurret: MainTurret {
            ...
            gunnerRightH&&AnimName = "OtocHlavenSUV";
            gunnerLeftH&&AnimName = "OtocHlavenSUV";
        ...
        class CargoTurret_1: CargoTurret {
            ...
            maxTurn = 130;
            minTurn = 25;
            gunnerActiton "passenger_flatground_2";
