class CfgVehicles {
    ...
    class CLASS(Unit_I_Contractor): CLASS(Unit_Polo_TP_LS_TP_TB) {
        weapons[] = {"hlc_rifle_M4", "hgun_P07_F", "Binocular", "Throw", "Put"};
        respawnWeapons[] = {"hlc_rifle_M4", "hgun_P07_F", "Binocular", "Throw", "Put"};
    ...
    class CLASS(Unit_I_Contractor_GL): CLASS(Unit_Combat_RS_BS_GP_BB) {
        weapons[] = {"hlc_rifle_m4m203", "hgun_P07_F", "Binocular", "Throw", "Put"};
        respawnWeapons[] = {"hlc_rifle_m4m203", "hgun_P07_F", "Binocular", "Throw", "Put"};
    ...
    class CLASS(Unit_I_TeamLeader): CLASS(Unit_TShirt_JP_GS_LP_BB) {
        weapons[] = {"hlc_rifle_M4", "hgun_Rook40_F", "Binocular", "Throw", "Put"};
        respawnWeapons[] = {"hlc_rifle_M4", "hgun_Rook40_F", "Binocular", "Throw", "Put"};
