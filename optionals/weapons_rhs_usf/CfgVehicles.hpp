class CfgVehicles {
    ...
    class CLASS(Unit_I_Bodyguard): CLASS(Unit_Polo_CP_LS_TP_OB) {
        weapons[] = {QCLASS(rhs_MP7A2_xps3_grip3), "rhsusf_weap_glock17g4", "Binocular", "Throw", "Put"};
        respawnWeapons[] = {QCLASS(rhs_MP7A2_xps3_grip3), "rhsusf_weap_glock17g4", "Binocular", "Throw", "Put"};
    ...
    class CLASS(Unit_I_Contractor): CLASS(Unit_Polo_TP_LS_TP_TB) {
        weapons[] = {QCLASS(rhs_m4_pmag_acog_grip1_m952v), "rhsusf_weap_glock17g4", "Binocular", "Throw", "Put"};
        respawnWeapons[] = {QCLASS(rhs_m4_pmag_acog_grip1_m952v), "rhsusf_weap_glock17g4", "Binocular", "Throw", "Put"};
    ...
    class CLASS(Unit_I_Contractor_GL): CLASS(Unit_Combat_RS_BS_GP_BB) {
        weapons[] = {QCLASS(rhs_m4_m203_eotech_m952v), "rhsusf_weap_glock17g4", "Binocular", "Throw", "Put"};
        respawnWeapons[] = {QCLASS(rhs_m4_m203_eotech_m952v), "rhsusf_weap_glock17g4", "Binocular", "Throw", "Put"};
    ...
    class CLASS(Unit_I_Engineer): CLASS(Unit_Polo_TP_LS_TP_TB) {
        weapons[] = {QCLASS(rhs_m4_mstock_xps3_grip2_m952v), "rhsusf_weap_glock17g4", "Binocular", "Throw", "Put"};
        respawnWeapons[] = {QCLASS(rhs_m4_mstock_xps3_grip2_m952v), "rhsusf_weap_glock17g4", "Binocular", "Throw", "Put"};
    ...
    class CLASS(Unit_I_Specialist): CLASS(Unit_Combat_RS_BS_GP_BB) {
        weapons[] = {QCLASS(rhs_m249_pip_eotech), "rhsusf_weap_glock17g4", "Binocular", "Throw", "Put"};
        respawnWeapons[] = {QCLASS(rhs_m249_pip_eotech), "rhsusf_weap_glock17g4", "Binocular", "Throw", "Put"};
    ...
    class CLASS(Unit_I_Marksman): CLASS(Unit_TShirt_JP_GS_LP_BB) {
        weapons[] = {QCLASS(rhs_sr25_m8541_harris), "rhsusf_weap_glock17g4", "Binocular", "Throw", "Put"};
        respawnWeapons[] = {QCLASS(rhs_sr25_m8541_harris), "rhsusf_weap_glock17g4", "Binocular", "Throw", "Put"};
