class CfgVehicles {
        ...
        class TextureSources {
            class CLASS(Fleck) {
                ...
                textures[] = {
                    ...
                    "bwa3_backpacks\data\bwa3_backpack_fleck_co.paa",
                    QPATHTOF(data\bwa3_normteile_co.paa),
    ...
    class CLASS(BWA3_I_Eagle_FLW100_Fleck): BWA3_Eagle_FLW100_Fleck {
        ...
        textureList[] = {QCLASS(Fleck), 1};
        forceInGarage = 0; // BWA3 Forces that to show FLW 100 variant as separate properly
    };
    ...
    class CLASS(BWA3_I_Eagle_FLW100_Tropen): BWA3_Eagle_FLW100_Tropen {
        ...
        textureList[] = {
            QCLASS(Tropen),  0.125,
            QCLASS(Tropen2), 0.125,
            QCLASS(Tropen3), 0.125,
            QCLASS(Tropen4), 0.125,
            QCLASS(Tropen5), 0.125,
            QCLASS(Tropen6), 0.125,
            QCLASS(Tropen7), 0.125,
            QCLASS(Tropen8), 0.125
        };
    };
