class CfgVehicles {
    ...
    class CLASS(Unit_I_Contractor): CLASS(Unit_Combat_LS_BS_TP_TB) {
        weapons[] = {QCLASS(arifle_HK416_Mod), "hgun_P07_F", "Binocular", "Throw", "Put"};
        respawnWeapons[] = {QCLASS(arifle_HK416_Mod), "hgun_P07_F", "Binocular", "Throw", "Put"};
    ...
    class CLASS(Unit_I_Contractor_GL): CLASS(Unit_Combat_LS_BS_TP_TB) {
        weapons[] = {QCLASS(arifle_HK416GL_Mod), "hgun_P07_F", "Binocular", "Throw", "Put"};
        respawnWeapons[] = {QCLASS(arifle_HK416GL_Mod), "hgun_P07_F", "Binocular", "Throw", "Put"};
    ...
    class CLASS(Unit_I_Marksman): CLASS(Unit_Garment_RS_GS_GP_BB) {
        weapons[] = {QCLASS(arifle_MXM_Mod), "hgun_P07_F", "Binocular", "Throw", "Put"};
        respawnWeapons[] = {QCLASS(arifle_MXM_Mod), "hgun_P07_F", "Binocular", "Throw", "Put"};
    ...
    class CLASS(Unit_I_Specialist): CLASS(Unit_Combat_RS_GS_BP_BB) {
        weapons[] = {QCLASS(arifle_FN_Mod)};
        respawnWeapons[] = {QCLASS(arifle_FN_Mod)};
